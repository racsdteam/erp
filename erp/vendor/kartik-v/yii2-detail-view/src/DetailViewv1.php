...
HTML;
     ...
     */
    public $buttons1 = '{view}{update}{print}{save}';
   ...
   //--------------------------custom--------------------------------------------------------------- 
        ...
        switch ($type) {
            ...
            case 'reset':
                return $this->getDefaultButton('reset', 'ban-circle', 'ban', Yii::t('kvdetail', 'Cancel Changes'));
                 case 'print':
                return $this->getDefaultButton('print', 'print', 'print', Yii::t('kvdetail', 'Print'));
            default:
                return '';
        }
    }
    ...
    protected function getDefaultButton($type, $iconBs3, $iconBs4, $title)
    {
        ...
        Html::addCssClass($options, 'kv-action-' . $type);
