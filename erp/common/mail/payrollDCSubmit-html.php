...
<div class="task-notification">
    ...
    <p><b><?= $requester->first_name .' '.$requester->last_name ?></b> has submitted  Deductions and Contributions for <?= date("F", mktime(0, 0, 0, $request->pay_period_month, 10))
    ." ".$request->pay_period_year ?> in <b>ERP</b></p>
  
    <p>Follow the link below to provide Approval or Review :</p>
    <p><?= Html::a('Review/Approval Deductions and Contributions', $taskLink) ?></p>
