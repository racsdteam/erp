...
a.nav-link.text-dark:hover {
 ...
 .task-container .list-group .list-group-item {
...
<div class="d-flex flex-row flex-wrap  task-container">
   
    <div class="flex-fill list-group p-1 task-box">
        
   
        <a href="<?=Url::to(['doc/erp-memo/pending'])?>" class="list-group-item list-group-item-action list-group-item-success d-flex justify-content-between align-items-center mb-1 ">
    <span><i class="ion  ion-ios-compose-outline mr-1"></i>Memo</span>
    <span class="badge bg-primary"><?=$memo->pending($userID,false)?></span>
  </a>
     
      <a href="<?=Url::to(['doc/erp-requisition/pending'])?>" class="list-group-item list-group-item-action list-group-item-success d-flex justify-content-between align-items-center mb-1">
   ...
   <a href="<?=Url::to(['doc/erp-lpo/pending'])?>" class="list-group-item list-group-item-action list-group-item-success d-flex justify-content-between align-items-center mb-1">
  <span><i class="ion ion-ios-paper-outline  mr-1"></i>LPO</span>
    <span class="badge bg-primary"><?=$lpo->pending($userID,false)?></span>
     ...
     <div class="flex-fill list-group task-box p-1">
  
   <a href="<?=Url::to(['doc/erp-lpo-request/pending-requests'])?>" class="list-group-item list-group-item-action list-group-item-success  d-flex justify-content-between align-items-center mb-1">
  <span><i class="ion ion-ios-copy-outline  mr-1"></i>Requests For LPO</span>
    <span class="badge bg-primary"><?=$lpoReq->pending($userID,false)?></span>
        ...
        <a href="<?=Url::to(['logistic/request-to-stock/pending'])?>" class="list-group-item list-group-item-action  list-group-item-success d-flex justify-content-between align-items-center mb-1">
     <span><i class="ion ion-bag  mr-1"></i> Stock Vauchers </span>
    <span class="badge bg-primary"><?=$logistic->pending($userID,true) ?></span>
  </a>
     
      <a href="<?=Url::to(['hr/payroll-approval-task-instances/pending'])?>" class="list-group-item list-group-item-action list-group-item-success d-flex justify-content-between align-items-center mb-1">
  <span><i class="ion ion-calculator mr-1"></i>Payrolls</span>
    <span class="badge bg-primary"><?=$payroll->pending($userID,true) ?></span>
     ...
     <div class="flex-fill list-group task-box p-1">
        ...
        <a href="<?=Url::to(['hr/leave-approval-task-instances/pending'])?>" class="list-group-item list-group-item-action list-group-item-success d-flex justify-content-between align-items-center mb-1">
   <span><i class="ion ion-paper-airplane mr-1"></i>Leaves</span>
    <span class="badge bg-primary"><?=$leave->pending($userID,true) ?></span>
  </a>
          
        <a href="<?=Url::to(['doc/erp-travel-request/pending'])?>" class="list-group-item list-group-item-action list-group-item-success d-flex justify-content-between align-items-center mb-1">
     <span><i class="ion ion-plane  mr-1"></i>Travel Requests</span>
    <span class="badge bg-primary"><?= $travelReq->pending($userID,false)?></span>
  </a> 
      
        <a href="<?=Url::to(['hr/pc-approval-task-instances/pending'])?>" class="list-group-item list-group-item-action list-group-item-success d-flex justify-content-between align-items-center mb-1">
    ...
    <span class="badge bg-primary"> <?=$leave->pending($userID,true) ?></span>
     ...
     <div class="flex-fill list-group task-box p-1">
                ...
                <a href="<?=Url::to(['doc/erp-document/in-documents'])?>" class="list-group-item list-group-item-action list-group-item-success d-flex justify-content-between align-items-center mb-1">
