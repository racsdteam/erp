                                    ...
                                    <?php $i++; ?>
                                     <tr  class="<?php if($row['approved']==0){echo 'new';}else{echo 'read';}  ?>">
                                          <td><?php echo $i  ;?></td>
                                           ...
                                           <td><?= Html::a('<i class="material-icons">check</i><span></span>',Url::to(['user/user-approve','id'=>$row['id']]) ,
                                                
                ['class' => 'btn btn-info btn-circle waves-effect waves-circle waves-float action-approve-user','title'=>'View User Info']) ?></td>
