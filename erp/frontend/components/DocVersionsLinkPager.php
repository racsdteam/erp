 ...
 * @since 2.0
 */
class DocVersionsLinkPager  extends \yii\bootstrap4\LinkPager
{
    /**
    ...
    protected function renderPageButtons()
    {
        ...
        $version_number=count($this->getPageRange());
        for ($i = $beginPage; $i <= $endPage; ++$i) {
            
          
            
            $buttons[] = $this->renderPageButton('v'.$version_number, $i, null, $this->disableCurrentPageButton && $i == $currentPage, $i == $currentPage);
