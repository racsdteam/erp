...
use Yii;
use frontend\modules\procurement\models\TenderStaffs;
...
/**
 * TenderStaffsController implements the CRUD actions for TenderStaffs model.
 */
class TenderStaffsController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all TenderStaffs models.
     * @return mixed
     */
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => TenderStaffs::find(),
        ]);
   ...
   /**
    ...
    {
        $model = new TenderStaffs();
        if (Yii::$app->request->isPost) {
            $user_id=Yii::$app->user->identity->user_id;
            $post_data=Yii::$app->request->post();
            $model->attributes=array_filter($post_data['TenderStaffs']);
     ...
     * @param integer $_id
     * @return TenderStaffs the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TenderStaffs::findOne($id)) !== null) {
