...
$this->title = $model->approvalRequest->name;
...
?>   
    <div class="row mb-2 action-bar ">
       ...
       data-url="<?= Url::to(["procurement-plan-approvals/complete"])?>" style="margin-right: 5px;">
...
?>  
    ...
    echo  $this->render('@frontend/modules/procurement/views/procurement-plans/pdf',['model' => $request]);   
...
$approvalConfirmUrl=Url::to(['procurement-plan-approval-annotations/confirm-approval']);
$locationUrl=Url::to(['procurement-plan-approvals/pending']);
