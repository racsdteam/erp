...
<div class="callout callout-warning">
                  <h5>Currencies Allowed!</h5>

                  <p>Type of currencies allowed by RAC procuremnt Office.</p>
                </div>
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
     <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Currency ', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create','title'=>'Add Currency']) ?>
    </p>   
