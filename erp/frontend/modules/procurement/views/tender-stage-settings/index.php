...
$this->title = 'Tender Stage Settings';
...
<div class="callout callout-warning">
                  <h5>Tender Stages Setting!</h5>

                  <p>These are all process stages that a tender have to pass through.</p>
                </div>
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
     <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Stage ', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create','title'=>'Add Stage']) ?>
    </p>   
