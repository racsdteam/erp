...
$this->title = 'Procurement Methods';
...
<div class="callout callout-warning">
                  <h5>Procurement Methods!</h5>

                  <p> the approach or process used by RAC to acquire goods, services, or works from external suppliers</p>
                </div>
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
     <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Method ', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create','title'=>'Add Procurement Method']) ?>
    </p>   
