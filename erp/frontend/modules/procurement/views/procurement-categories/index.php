...
$this->title = 'Procurement Categories';
...
<div class="callout callout-warning">
                  <h5>Procurement Category!</h5>

                  <p> classification of goods, services, and works that RAC acquires through the procurement process</p>
                </div>
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
     <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Category ', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create','title'=>'Add Procurement Category']) ?>
    </p>   
