...
<div class="card card-default ">
 <div class="card-header">
   <h3 class="card-title"><i class="fas fa-gavel"></i> Active</h3>
 </div>
 <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        <th align="center">Actions</th>
                                          ...
                                          <th>Description</th>
                                            ...
                                            <th>Online_start time</th>
                                            <th>Online_end time</th>
                                    ...
                                    <tr class="<?php if($row['is_new']==1){echo 'new';}else{echo 'read';}  ?>">
                                       <td>  <?=
                                         ...
                                         <td nowrap>
                                          ...
                                          ,['class'=>'btn-primary btn-sm active ','title'=>'View Auction Info'] ); ?> 
