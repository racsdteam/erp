          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Realy Time Lots Data</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body ">
                <div class="table-responsive">
                  <table class="table ">
                    ...
                    <tr>
                      ...
                      <th>Bid Reserve (Frws)</th>
                      <th>Max Bid (Frws)</th>
                      
                    </tr>
                    </thead>
                    <tbody>
                    <tr v-for="n in lots.length">
                         <template v-if="lots!=null ">
                      <td>{{ n }}</td>
                      <td>{{ lots[n-1] }}</td>
                      <td>{{ lotsbids[n-1] }} </td>
                      <td>{{ lotsinitprice[n-1] }}</td>
                       <td>{{ lotsmaxbid[n-1].toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") }}</td>
                       </template>
                    </tr>
                    </tbody>
                  </table>
