...
$user=Yii::$app->user->identity;
                                     ...
                                     $homeUrl=url::to(['/hr']);
                                     if(Yii::$app->request->url==='/erp/racdms'){
                                        $homeUrl=url::to(['/']); 
                                     }
...
.user-image{
   ...
   <nav class="main-header navbar navbar-expand-md navbar-dark navbar-warning">
    ...
    if(isset($this->params['showSideMenu']) && $this->params['showSideMenu']==true):?>
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a class="nav-link"  href="<?=Url::to(['default/admin'])?>">
 ...
 <?=Html::a(' Sign Out', ['/site/logout'],['data' => ['method' => 'post'],'class'=>["btn btn-success btn-block"]]) ?>
