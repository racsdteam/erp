...
<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
 ...
 <!---- ----------------------------------------------------------------------------------------------------->
   ...
   <?= $form->field($doc, 'inheritAccess')->inline()->radioList([ '1' => 'Inherit from parent','0' => 'Custom'])->label(false) ?>
  ...
  <?php ActiveForm::end(); ?>
   ...
   if($doc->inheritAccess){
       
    echo $this->render('inherit-access',['doc'=>$doc]);   
...
<label class="col-sm-2 col-form-label" for="owner-select">doc Owner</label>
 ...
 <div class=" card-footer pb-0 mb-5">
        ...
        <div class="form-group row mb-0">  
             ...
             <?php $items=[Tblacls::M_NONE=>"No Access",Tblacls::M_READ=>"Read",Tblacls::M_READWRITE=>"ReadWrite",Tblacls::M_ALL=>"Full Control"]; ?>
                   ...
                   <?= $form->field($doc, 'defaultAccess')->widget(Select2::classname(), [
    'data' =>$items,
...
//------------------get default selected radio-------------------------
   var radioValue = $("input[name='Tbldocuments[inheritAccess]']:checked").val();
   //-----------------show corresponding view-------------------------
   $('#access-form'+radioValue).show();
   //----------------------disable not checked-------------------------------------------
   $("input[name='Tbldocuments[inheritAccess]']").prop('disabled', function(){ return !this.checked; });
    ...
    $.ajax({
     ...
     response.data.message,
      'success'
            ...
            $('#w0 a[href="#w0-tab2"]').trigger('click');
            ...
            else if(response.data.action=='inherit'){
