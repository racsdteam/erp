 ...
 */
class PayrollApprovalRequestInstances  extends ApprovalWorkflowInstances
{
    
    const ENTITY_TYPE = 'PayrollApprovalRequests';
    const TASK_CLASS='frontend\modules\hr\models\PayrollApprovalTaskInstances';
    const CMT_CLASS='frontend\modules\hr\models\PayrollApprovalComments';
    const TASK_SBM_EMAIL='payrollSubmit-html';
       ...
       return $res;  
         ...
         if($res['status']!='success'){
           return $res;
            ...
            $this->entityRecord->trigger(PayrollApprovalRequests::EVENT_REQUEST_APPROVAL);
            }
   ...
   protected function complete($outcome){
    ...
    $entityRecord->trigger(PayrollApprovalRequests::EVENT_REQUEST_APPROVAL); 
    }
    $res['status']='success';
    return $res;
...
{
    return $this->hasOne(PayrollApprovalRequests::className(), ['id' =>'entity_record']);
}
