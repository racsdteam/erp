 ...
 */
class PayrollApprovalTaskInstances extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'payroll_approval_task_instances';
    }
...
public static function find()
    {
        return new PayrollApprovalTaskInstancesQuery(get_called_class());
    }
     public function getApprovalRequest()
{
    return $this->hasOne(PayrollApprovalRequests::className(), ['id' => 'request']);
}
...
{
    return PayrollApprovalComments::find(['user' =>$this->assigned_to])->andwhere(['wfStep'=>$this->wfStep])->one();  
} 
