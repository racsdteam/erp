 ...
 */
class PcApprovalTaskInstances extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'pc_approval_task_instances';
    }
...
public static function find()
    {
        return new PcApprovalTaskInstancesQuery(get_called_class());
    }
     public function getApprovalRequest()
{
    return $this->hasOne(PerformanceContract::className(), ['id' => 'request']);
}
...
{
    return PcApprovalComments::find(['user' =>$this->assigned_to])->andwhere(['wfStep'=>$this->wfStep])->one();  
} 
