...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fa fa-tag"></i>Approved Imihigo</h3>
 </div>
 <div class="card-body">
 ...
 $q1=" SELECT *  FROM    performance_contract where user_id='".Yii::$app->user->identity->user_id."' and status='approved'  order by timestamp desc";
