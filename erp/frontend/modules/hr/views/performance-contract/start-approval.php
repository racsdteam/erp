...
<?php  
  ...
  $wfModel=Yii::$app->wfManager->getWorkflowModel($model,$model->user_id);
  if($wfModel!=null)
...
?>
 ...
 <div class="card card-warning text-dark ">
       ...
       <div class="callout callout-warning">
                  <h5><i class="fas fa-people-arrows"></i> Imihigo form will be submitted to the following Reviewers/Approvers :  </h5>
