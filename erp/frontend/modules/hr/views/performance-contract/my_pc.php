...
$this->title = 'worked on Imihigo forms';
...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fa fa-tag"></i>worked on Imihigo forms</h3>
 </div>
 <div class="card-body">
 ...
 $q1=" SELECT *  FROM    performance_contract where user_id='".Yii::$app->user->identity->user_id."'   order by timestamp desc";
