...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fa fa-tag"></i>Draft for Imihigo</h3>
 </div>
 <div class="card-body">
 ...
 $q1=" SELECT *  FROM    performance_contract where user_id='".Yii::$app->user->identity->user_id."' and status='draft'   order by timestamp desc";
 ...
 <table class="table table-cases table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <div style="text-align:center" class="centerBtn">
                                             ...
                                             Url::to(["performance-contract/view",'id'=>$row['id']])
                                          
                                          ,['class'=>'btn-info btn-sm active action-viexw','title'=>'View Imihigo Info'] ); ?>|
                                          
                                           <?=Html::a('<i class="fa fa-edit"></i> Edit',
                                             Url::to(["performance-contract/update",'id'=>$row['id']])
                                          ,['class'=>'btn-warning btn-sm active action-viexw','title'=>'Edit Imihigo Info'] ); ?>|
                                          
                                          <?=Html::a('<i class="fa fa-trash"></i> Delete',
                                             
                                             Url::to(["performance-contract/delete",'id'=>$row['id']])
                                          
                                          ,['class'=>'btn-danger btn-sm active action-delete','title'=>'Delete Imihigo Info'] ); ?>
                         </div>
