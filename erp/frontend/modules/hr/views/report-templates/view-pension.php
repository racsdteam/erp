...
?>
            ...
            <th class="rotate text-left"><div><div class="textH">Type Declared</div> </div></th>
             ...
             <th class="rotate text-left"><div><div class="textH"> ID Number</div> </div></th>
              <th class="rotate text-left"><div><div class="textH">Emp No.</div> </div></th>
               ...
               <th class="rotate text-left"><div><div class="textH"> RSSB Employee Contrib. 3%</div> </div></th>
               <th class="rotate text-left"><div><div class="textH"> RSSB Pension Employer Contribution 5% </div> </div></th>
               <th class="rotate text-left"><div><div class="textH"> Total (8%)</div> </div></th>
 ...
 <?php foreach( $rows as $row): $i++;?> 
                ...
                <td><?= $i?></td>
                 ...
                 <td class="data-cell" nowrap> <?php $totBasic+=$row['pension_basis'] ; echo number_format($row['pension_basis']);?></td>
                 <td class="data-cell" nowrap> <?php $totEE+=($ee=round($row['RSSBPEE'])) ; echo number_format($row['RSSBPEE']);?></td>
                 <td class="data-cell" nowrap>  <?php $totER+=($er=round($row['RSSBPER'])); echo number_format($row['RSSBPER']);?></td>
