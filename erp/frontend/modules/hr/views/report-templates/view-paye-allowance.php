...
?>
 ...
 <table style="margin: 0 auto;" class="table table-bordered tbl-report  tbl-dc" cellspacing="0" cellpadding="0" border="1" width="80%">
   <thead>
      <tr>
       ...
       <th class="rotate text-left"><div><div class="textH">Allowance</div> </div></th>
 ...
 <?php foreach( $rows as $row): $i++?> 
                <tr class="rpt-row"> 
                 ...
                 <td class="data-cell" nowrap> <?php $totAllowance+=$row['paye_basis'] ; echo number_format($row['paye_basis'])?></td> 
...
<th  class="total text-left text-bold"><?=number_format($totAllowance)?></th> 
