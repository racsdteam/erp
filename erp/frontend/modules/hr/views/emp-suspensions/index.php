...
$this->title = 'Suspended Employees';
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                return date('d/m/Y',strtotime($model->susp_from));
            }
                ],
                 [
               ...
               return  is_null($model->last_day)?'':date('d/m/Y',strtotime($model->last_day));    
           ...
           [
                 ...
                 'value'=>function ($model) {
                  return  is_null($model->susp_reason)?'':$model->susp_reason;      
            }
                ],
           [
                 ...
                 return $model->susp_note!=null ?  $model->susp_note : '';
            }
                ],
