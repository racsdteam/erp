                                    ...
                                    <?php   $i++;?>
                                     ...
                                     <tr>
                                            ...
                                            <td> 
                                              ...
                                              Yii::$app->urlManager->createUrl(["erp-org-units/view",'id'=>$row['id'],'level'=>$level->id,
                                              
                                           ])
                                          ,['class'=>'btn-info btn-sm active btn-view','title'=>$row["unit_name"]]); ?> </td>
                                            <td> 
                                                 <?=Html::a('<i class="fa fa-edit"></i>',
                                              Yii::$app->urlManager->createUrl(["erp-org-units/update",'id'=>$row['id'],'level'=>$level->id
                                           ])
                                          ,['class'=>'btn-info btn-sm active btn-update','title'=>$row["unit_name"] ]); ?> </td>
