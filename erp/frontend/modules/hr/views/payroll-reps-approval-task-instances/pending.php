...
$this->title = 'Pending  Payroll Reports Approvals';
...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fas fa-inbox"></i> Pending  Payroll Reports Approvals</h3>
 </div>
 <div class="card-body">
 ...
 <table class="table table-cases table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <div style="text-align:center" class="centerBtn">
                                             ...
                                             Url::to(["payroll-reps-approval-task-instances/view",'id'=>$task->id])
