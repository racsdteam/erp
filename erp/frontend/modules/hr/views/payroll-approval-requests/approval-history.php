    ...
    [
        'columns' => [
            ...
            [
                'attribute'=>'initiator', 
                'label'=>'Started By',
                'value'=>$wf->wfInitiator->first_name.' '.$wf->wfInitiator->last_name,
                'displayOnly'=>true,
                'valueColOptions'=>['style'=>'width:30%']
            ],
        ],
...
echo DetailView::widget([
 ...
 <!-------------Approval List--------------------------------------------->        
  <?php if(!empty($wf->reviewStepInstances))  : ?>       
  <?php $i=1; $size=count($wf->reviewStepInstances); foreach($wf->reviewStepInstances as $step) : $res=$stepStatusCallBack($step);?>
<div class="card card-outline <?php echo $res['cardClass'];?>">
              ...
              <div class="card-body">
               ...
               $approvals=$step->getTaskInstances($wf::TASK_CLASS);
               if(!empty( $approvals)) :
