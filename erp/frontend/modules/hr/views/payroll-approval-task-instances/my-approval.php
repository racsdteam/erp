...
$this->title = 'My Approvals And Review For Payrolls';
...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fas fa-inbox"></i>My Approvals And Review For Payrolls</h3>
 </div>
 <div class="card-body">
 ...
 <table class="table table-cases table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                        ...
                                        <th align="center">Actions</th>
                                          <th>Year</th>
                                         <th>Month</th>
                                          <th>Payroll Approval Status</th>
                                         <th>Action</th> 
                                         <th>Action Started</th> 
                                        <th>Action End</th>
                                        </tr>
                                    </thead>
                            ...
                            <div style="text-align:center" class="centerBtn">
                                             ...
                                             Url::to(["payroll-approval-requests/view",'id'=>$request->id])
