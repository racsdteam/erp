...
<div class="row clearfix">
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                 ...
                 <div class="card card-default ">
                       ...
                       <div class="card-header ">
                            <h3 class="card-title"><i class="fas fa-layer-group"></i> Pay Templates</h3>
                       </div>
  ...
  <div class="callout callout-info">
    ...
    <dl>
                  <dt>Pay Template!</dt>
                  <dd>Pay Template is use to define a set of pay items  applied to a category of employees that qualify for similar pay structures</dd>
   ...
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
    ...
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Pay Template', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create1','title'=>'Add New Pay Template']) ?>
    </p>   
