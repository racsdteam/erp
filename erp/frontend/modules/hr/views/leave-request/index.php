...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fa fa-tag"></i>All Request For Leave</h3>
 </div>
 <div class="card-body">
 ...
 $q1=" SELECT r.*  FROM leave_request as r   order by r.timestamp desc";
 ...
 <table class="table table-cases table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <div style="text-align:center" class="centerBtn">
                                          ...
                                          ,['class'=>'btn-info btn-sm active action-viexw','title'=>'View Leave Info'] ); ?>|
                                             ...
                                             Url::to(["leave-request/doc-tracking",'id'=>$row['id']
                                           ])
