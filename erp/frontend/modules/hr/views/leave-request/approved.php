...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fa fa-tag"></i>Approved Request For Leave</h3>
 </div>
 <div class="card-body">
 ...
 $q1=" SELECT r.*  FROM leave_request as r where r.user_id='".Yii::$app->user->identity->user_id."' and r.status='approved'   order by r.timestamp desc";
