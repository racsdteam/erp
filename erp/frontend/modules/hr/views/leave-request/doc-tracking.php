...
<?php 
     ...
     $q="SELECT f.*  FROM leave_approval_flow  as f where f.request={$id}  order by f.timestamp desc";
							...
							<div class="widget-box transparent">
								<div class="widget-header widget-header-small">
									<h5 class="widget-title smaller">
										...
										<span class="grey"> received Leave Request</span>
									</h5>
...
function getUserSendInfo($user,$id,$doc){
   ...
   $q="SELECT f.*  FROM  leave_approval_flow as f where f.id > {$id} and 	f.originator={$user} and f.request={$doc}";
