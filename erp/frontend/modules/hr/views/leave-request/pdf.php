...
I 
 ...
 <?php
      ...
      $requestUrl=Url::to(['leave-request/pdf-data','id'=>$model->id]);
...
<figure>
  <div style="height: 600px;" id="leave-pdf-<?php echo $model->id ?>"></div>
  <figcaption>Leave Form </figcaption>
  ...
  <!--commenting   --> 
          ...
          <?php
 $serverURL=Url::to(['leave-annotations/annotations-handler']);
 $id=$model->id;
...
$(function() {
  ...
  showViewer('{$full_path}','{$serverURL}','{$id}', user ,'leave-pdf-{$id}');
});
