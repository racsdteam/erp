...
<div class="row clearfix">
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  ">
                  ...
                  <?php $payItemsList=PayItems::find()->orderBy([
    'sequence' => SORT_ASC //specify sort order ASC for ascending DESC for descending      
    ])->all()?>
  ...
  <ul class="todo-list ui-sortable" data-widget="todo-list">
           ...
           <?php 
            ...
            foreach($payItemsList as $payItem)
           
           :?> 
           
           
            <li id=<?php echo $payItem->id; ?> >
                    <!-- drag handle -->
                    ...
                    <!-- todo text -->
                    <span class="text"><?php echo $payItem->edDesc?></span>
