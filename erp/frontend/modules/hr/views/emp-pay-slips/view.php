...
<div class="col-sm-12">
 ...
 <div class="col-sm-12 invoice-col">
  ...
  <h4 class=" text-center mb-3"><b>Pay Slip for the period of <?= date("F", mktime(0, 0, 0, $payPeriod->pay_period_month, 10)).' '.$payPeriod->pay_period_year ?></b></h4>
                ...
                <div class="col-12 table-responsive">
                  <table border="0" class="edTable "  width='100%'>
                    ...
                    <tbody>
                     ...
                     <tr>
                        <th colspan="2" ><span class="float-left">Total Earnings</span><span class="float-right"><?php echo number_format($tot_en); ?></span></th>
