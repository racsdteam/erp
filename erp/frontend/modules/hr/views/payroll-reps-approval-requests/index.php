...
$this->title = 'Payroll Reports Approval Requests';
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                 ...
                 <div class="card card-default ">
                       ...
                       <div class="card-header ">
                            <h3 class="card-title"><i class="fas fa-chart-line"></i> Payroll Reports Approval Requests</h3>
                       </div>
 ...
 <div class="float-right">
   ...
   <div class="table-responsive">
                  <table id="tbl-payroll"  class=" table table-bordered">
                    ...
                    <div class="margin">
                      <div class="btn-group">
                       <?= Html::a('<i class="fas fa-binoculars"></i> Open', Url::to(['payroll-reps-approval-requests/view','id'=>$model->id]), [
                             'data' => ['method' => 'post'],
                      ...
                      <?php if($model->status =='draft') : ?>
                        <div class="btn-group">
                        <?= Html::a('<i class="fas fa-pencil-alt"></i> Edit', Url::to(['payroll-reps-approval-requests/update','id'=>$model->id]), [
                            'data' => ['method' => 'post'],
