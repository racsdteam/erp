...
<div class="callout callout-info">
                  ...
                  <p> Employee groups are logical sets of employees. Employee groups can be useful while assigning tasks or generating reports.</p>
                </div>
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
     <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Employee Group ', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create','title'=>'Add Employee Group']) ?>
    </p>   
