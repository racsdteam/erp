...
<div class="pc-approval-task-instances-view">
  <?php
...
?>   
    <div class="row mb-2 action-bar ">
       ...
       data-url="<?= Url::to(["pc-approval-task-instances/complete"])?>" style="margin-right: 5px;">
...
?>  
    ...
    <?php
  echo  $this->render('@frontend/modules/hr/views/performance-contract/page-viewer1',['model' => $model->approvalRequest,"wf"=>$model->wfInst]); 
