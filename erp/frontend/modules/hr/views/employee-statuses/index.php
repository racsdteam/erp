             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                 ...
                 <div class="card card-default ">
                       ...
                       <div class="card-header ">
                            <h3 class="card-title"><i class="far fa-lightbulb"></i> Employee Statuses</h3>
                       </div>
...
<div class="callout callout-info">
    ...
    <dl>
                  ...
                  <dd>Employee status is a system field that is used to indicate an employee's current status in the company</dd>
   ...
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
    ...
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Employee Status', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create','title'=>'Add New Employee Status']) ?>
    </p>   
