             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                 ...
                 <div class="card card-default ">
                       ...
                       <div class="card-header ">
                            <h3 class="card-title"><i class="fas fa-location-arrow"></i> Affiliate Agencies</h3>
                       </div>
               
           <div class="card-body">
<div class="callout callout-info">
                  <h5>Affiliate Agency!</h5>

                  <p>organisation or company external to RAC.</p>
                </div>
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
     <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Affiliate Agency', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create','title'=>'Add New Affiliate Agency']) ?>
    </p>   
