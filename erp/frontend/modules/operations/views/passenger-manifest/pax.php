...
{
$q2=" SELECT *  FROM passenger_manifest as p  where p.Operating_carrier_designator='".$airline."'  and p.flight_number='".$number."' and (recorded between   '".$date." 00:00:00'  and '".$date." 23:59:59')  ";
$q22=" SELECT count(*) as tot FROM passenger_manifest as p  where p.Operating_carrier_designator='".$airline."'  and p.flight_number='".$number."' and (recorded between   '".$date." 00:00:00'  and '".$date." 23:59:59')  ";
$q23=" SELECT count(*) as tot FROM passenger_manifest as p  where p.Operating_carrier_designator='".$airline."'  and p.flight_number='".$number."' and (recorded between   '".$date." 00:00:00'  and '".$date." 23:59:59')  and  from_city_airport_code ='KGL'";
...
<div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="small-box bg-orange">
            <div class="inner">
              <h3><?php echo   $r23[0]['tot'] ?></h3>

              <p>Scanned Boanding Pass</p>
            </div>
            <div class="icon">
...
<div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="small-box bg-green">
            <div class="inner">
              <h3><?php 
              $passengerfee=$r23[0]['tot']*40;
              echo   $passengerfee;?> $</h3>
              <p>Passengers Fees</p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-people"></i>
...
<div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php 
               $total=$securityfee+$passengerfee;
              echo   $total;?> $</h3>
