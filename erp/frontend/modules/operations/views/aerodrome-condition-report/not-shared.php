...
$this->title = 'Not shared Aerodrome Condition Reports';
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                 ...
                 <div class="card card-default ">
                       ...
                       <div class="card-header ">
                            <h3 class="card-title"><i class="fas fa-database"></i>Not Shared Aerodrome condition Report</h3>
                       </div>
                    ...
                    'delete' => function ($url, $model, $key) {
                         ...
                         return Html::a('<i class="fas fa-times"></i>', $url, ['class'=>['text-danger pr-1'],
                            'title' => Yii::t('app', 'Delete'),
                             'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this RCR ?'),
                             'data-method'  => 'post',
                             'data-pjax'    => '0',
                        ]);
                    }
