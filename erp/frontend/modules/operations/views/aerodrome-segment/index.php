...
$this->title = 'Aerodrome Segments';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="aerodrome-segment">
<div class="row clearfix">
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                 ...
                 <div class="card card-default ">
                       ...
                       <div class="card-header ">
                            <h3 class="card-title"><i class="fas fa-database"></i>Aerodrome Segment</h3>
                       </div>
   ...
   <p>
         <?= Html::a('<i class="fas fa-plus"></i> Add New Aerodrome  Segment', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-create','title'=>'Add New Aerodrome Segmet']) ?>
    </p>               
                  <!-- /.btn-group -->
                </div>
    <?= GridView::widget([
