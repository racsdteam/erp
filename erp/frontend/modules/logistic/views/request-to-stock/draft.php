...
$this->title = 'Draft Stock request(s)';
...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fa fa-tag"></i>Draft Stock Voucher(s)</h3>
 </div>
 <div class="card-body">
 ...
 $q1=" SELECT r.*  FROM  request_to_stock  as r where r.staff_id='".Yii::$app->user->identity->user_id."' and r.status='drafting'  order by r.timestamp desc";
                            ...
                            <div style="text-align:center" class="centerBtn">
                                          ...
                                          ,['class'=>'btn-warning btn-sm active','title'=>'Edit Voucher' ] ); ?>|
                                           ...
                                           <?=Html::a('<i class="fa fa-trash"></i> Delete',
                                              Url::to(["request-to-stock/delete",'id'=>$row1['reqtostock_id']
                                           ])
                                          ,['class'=>'btn-danger btn-sm active action-delete','title'=>'Delete Voucher','disabled'=>$row1["status"]!='drafting'] ); ?> 
...
Swal.fire({
  title: 'Are you sure?',
  text: "Stock Voucher will be Deleted !",
  icon: 'warning',
