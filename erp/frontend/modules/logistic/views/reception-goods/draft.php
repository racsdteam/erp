...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fa fa-tag"></i>Draft of Goods Received</h3>
 </div>
 <div class="card-body">
 ...
 $q1=" SELECT r.*  FROM reception_goods as r where r.user='".Yii::$app->user->identity->user_id."' and r.status='drafting'   order by r.timestamp desc";
 ...
 <table class="table table-cases table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <div style="text-align:center" class="centerBtn">
                                          ...
                                          ,['class'=>'btn-info btn-sm active action-viexw','title'=>'View GRN'] ); ?>|
                                    ...
                                    Url::to(['reception-goods/view','id'=>$row1["id"]]), ['class'=>'action-viewx']) ?></td>
                                    <td>
                                            <?=
                                           $row['name'] 
