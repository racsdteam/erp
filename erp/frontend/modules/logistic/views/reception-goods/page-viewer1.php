...
I 
 ...
 $ser_domain='https://rac.co.rw';
    ...
    $url=Url::to(['reception-goods/pdf-data','id'=>$model->id]);
...
<figure>
  ...
  <figcaption>Reception of goods </figcaption>
</figure>
...
<!-- <div class="v-right-side">
     ...
     <div class="qa-message-list" id="wallmessages">
    	 ...
    	 <?php   
          ...
          $query = "select f.* from reception_approval_flow as f  where f.reception = $model->id order By 
                f.timestamp desc";
...
?> 
  ...
  <!--commenting   --> 
          ...
          <?php
 $serverURL=Url::to(['reception-annotations/annotations-handler']);
 $id=$model->id;
