...
SmartWizardAsset::register($this);
 ...
 $q1=" SELECT f.* FROM reception_approval_flow  as f  where f.reception='".$model->id."' and status='pending' and  f.is_copy!=1 order by f.timestamp desc ";
...
<div class="card">
                        <div class="card-header">
                            ...
                            <h6 class="fa"> <i class="fa fa-opencart"></i>Good Received</h6>
   ...
   <div id="smartwizard">
            ...
            <ul class="nav">
                ...
                data-page=1 
                data-content-url="<?=Url::to(['reception-goods/fetch-tab','id'=>$model->id])?>" >Page 1<br /><small>Good Reception</small></a></li>
                <li><a href="#step-2" class="nav-link" data-content-url="<?=Url::to(['reception-goods/get-lop','id'=>$model->id,'stepcontent'=>2]) ?>">Page 2<br /><small>Received Note</small></a></li>
                  <li><a href="#step-3" class="nav-link" data-content-url="<?=Url::to(['reception-goods/get-support-docs','id'=>$model->id,'stepcontent'=>3]) ?>">Page 3<br /><small>Supporting Documents(s)</small></a></li>
                
                      <?php
                  if($row1['approver']==Yii::$app->user->identity->user_id || $model->status=='drafting')
                {
                ?>
                <li><a href="#step-4" class="nav-link" data-content-url="<?=Url::to(['reception-approval/work-flow','reception'=>$model->id]) ?>">Page 4 <br /><small>Work Flow Action(s)</small></a></li>
             <?php 
                }
                ?>
