...
<div class="card card-default color-palette-card">
 <div class="card-header with-border">
   <h3 class="card-title"><i class="fa fa-tag"></i>All Interim(s)</h3>
 </div>
 <div class="card-body">
 ...
 <table class="table table-cases table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tr>
                                       ...
                                       <td > <?php 
                                           ...
                                           where pp.person_id='".$row['person_interim_for']."' and pp.status=1  ";
                                        ...
                                        <td > <?php 
                                           ...
                                           echo '<small style="padding:10px;" class="label pull-left bg-green">'. $pos." [ ".$full_name." ]".'</small>';
