...
<div class="card card-default ">
 <div class="card-header ">
   <h3 class="card-title"><i class="fab  fa-opencart"></i> Purchase Orders</h3>
 </div>
 <div class="card-body">
...
$q1=" SELECT lpo.*  FROM  erp_lpo as lpo order by lpo.created desc";
...
'title'=>'View Lpo Info'] ); ?> |
                                        ...
                                        <?=Html::a('<i class="fa fa-recycle"></i> History',
                                          ...
                                          ,['class'=>'btn btn-primary btn-sm  action-view','title'=>'LPO Request tracking History' ] ); ?>     
