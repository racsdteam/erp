...
$lpo_path=Yii::$app->request->baseUrl . '/'.$model->lpo_upload;
$full_path=$ser_domain.$lpo_path;
$id=$model->id;
...
<div class="d-flex flex-sm-row flex-column">
 ...
 <!------------------------view--------------------------------------------> 
  ...
  <div class="d-flex flex-column">
      ...
      <figure>
  <div style="height: 600px;" id="lpo<?php echo $id ?>"></div>
  <figcaption><?php echo 'PO'?></figcaption>
</figure> 
   ...
   <div class="qa-message-list" id="wallmessages">
        ...
        ])->from('erp_lpo_approval_flow as f ')->where(['f.lpo' =>$id])->orderBy([
                'timestamp' => SORT_DESC,
...
$serverURL=Url::to(['erp-lpo-annotations/annotations-handler']);
...
showViewer( '{$full_path}','{$serverURL}','{$id}',user,'lpo{$id}' );
...
$('#linker .pagination li a').on('click', function (e) {
