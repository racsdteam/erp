...
$this->params['breadcrumbs'][] = $this->title;
 ...
 $q=" SELECT c.* FROM erp_claim_form as c inner join erp_claim_form_flow as f on c.id=f.claim_form
 inner join erp_claim_form_flow_recipients as r on f.id= r.flow_id  where r.recipient=".Yii::$app->user->identity->user_id." and r.status='processing'";
 ...
 <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      ...
                      <i class="fa fa-database"></i><span> Pending Claim form(s) </span>  
                      </a>
                    </h4>
                  </div>
