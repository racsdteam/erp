...
$this->params['breadcrumbs'][] = $this->title;
 ...
 $q=" SELECT  c.* FROM erp_claim_form as c   where c.created_by=".Yii::$app->user->identity->user_id." and c.status='drafting'";
                                         ...
                                         <td><?php echo $to ; ?></td>
                                          ...
                                          ,['class'=>'btn-info btn-sm active action-update','title'=>'Update person travel clearance Info' ] ); ?> </td>
                                             ...
                                             <td> 
                                              ...
                                              Url::to(["erp-claim-form/update",'id'=>$row['id']
                                           ])
                                          ,['class'=>'btn-info btn-sm active','title'=>'Update person travel clearance Info' ] ); ?> </td>
                                           
                                            <td> 
                                                 <?=Html::a('<i class="fa fa-remove"></i>',
                                              Url::to(["erp-claim-form/delete",'id'=>$row['id']
                                           ])
                                          ,['class'=>'btn-danger btn-sm active delete','title'=>'Update person travel clearance Info' ] ); ?> </td>
...
var url=$(this).attr('href');
    ...
    swal({
        title: "Are you sure",
        text: "You want to delete the claim form ?",
        type: "warning",
...
swal("could not be deleted !", "", "error");
