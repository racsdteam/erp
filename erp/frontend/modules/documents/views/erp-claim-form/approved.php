...
$this->title = 'Erp Approved Claim Forms';
$this->params['breadcrumbs'][] = $this->title;

 $q=" SELECT c.* FROM erp_claim_form as c  
 ...
 <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      ...
                      <i class="fa fa-cart-arrow-down"></i><span> About Claim Forms</span>  
                      </a>
                    </h4>
                  </div>
                                         ...
                                         <td><?php echo $to ; ?></td>
                                          ...
                                          ,['class'=>'btn-info btn-sm active action-update','title'=>'Update person travel clearance Info' ] ); ?> </td>
                                             ...
                                             <td> 
                                              ...
                                              Url::to(["erp-travel-clearance/update",'id'=>$row['id']
                                           ])
