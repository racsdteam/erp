...
I 
 ...
 $url=Url::to(['erp-lpo-request/pdf-data','id'=>$model->id]);
...
<figure>
  ...
  <figcaption>Transmission Slip </figcaption>
</figure>
...
<div class="v-right-side">
    ...
    <div class="qa-message-list" id="wallmessages">
        ...
        ])->from('erp_lpo_request_approval_flow as f ')->where(['f.lpo_request' =>$model->id])->orderBy([
                'timestamp' => SORT_DESC,
