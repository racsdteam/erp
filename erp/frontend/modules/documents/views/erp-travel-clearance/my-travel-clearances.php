   ...
   <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h4 class="box-title">
                      ...
                      <i class="fa fa-cart-arrow-down"></i><span> About My Travel clearance(s) </span>  
                      </a>
                    </h4>
                  </div>
       ...
       <?php 
       $q50 = new Query;
$q50	->select(['t.*'])->from('erp_travel_clearance as t')->where(['t.created_by'=>Yii::$app->user->identity->user_id])	;
...
<table class="table table-cases table-bordered table-striped table-hover dataTable js-exportable">
 ...
 $i++;                                
                                  ...
                                  ?>
                                     ...
                                     <tr class="<?php if($row5['status']=='drafting'){echo 'draft';}else{echo 'other';}  ?>">
                                         <td>
                                     <?php echo  $i; ?>
                                         ...
                                         <td><?php echo $row5["return_date"] ; ?></td>
                                          ...
                                          ,['class'=>'btn-info btn-sm active action-view','title'=>'View person travel clearance Info' ] ); ?> </td>
                                             <td> 
                                              ...
                                              Url::to(["erp-travel-clearance/update",'id'=>$row5['id']
                                           ])
                                          ,['class'=>'btn-info btn-sm active action-update','title'=>'Update person travel clearance Info' ] ); ?> </td>
                                           
                                           <td> 
                                                 <?=Html::a('<i class="fa fa-trash"></i>',
                                              Url::to(["erp-travel-clearance/delete",'id'=>$row5['id'],
                                           ])
                                          ,['class'=>'btn-info btn-sm active action-delete','title'=>'Delete Travel Clearance Info',
                                          'data-delete-ok'=> $status=='drafting' && $row5["created_by"]==Yii::$app->user->identity->user_id ] ); ?> </td>
