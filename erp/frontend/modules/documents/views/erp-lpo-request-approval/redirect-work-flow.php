...
$msg=  Yii::$app->session->getFlash('success');
 ...
 <div class="card-header ">
   <h3 class="card-title"><i class="fas fa-share"></i> Reassign Approval Request</h3>
 </div>
 <div class="card-body">
...
<?php 
        ...
        <?=$form->field($model, 'lpo_request')->hiddenInput(['value'=>$id])->label(false); ?>
        ...
        <?= $form->field($model, 'employee')->dropDownList($employees, 
			...
			<?php $model->final_approval_status=0 ?>
			 ...
			 <?= $form->field($model, 'final_approval_status')->radioList($items)->label("Set As Final Approver");
                  ...
                  ?>
          <?= Html::a('<i class="fas fa-share"></i>  Reassign', ['#'], ['class'=>'btn btn-primary btn-submit active']) ?>           
