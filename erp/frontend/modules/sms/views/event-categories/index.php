...
<div class="row clearfix">
             ...
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                 ...
                 <div class="card card-default ">
                       ...
                       <div class="card-header ">
                            <h3 class="card-title"><i class="fas fa-file"></i> <?= Html::encode($this->title) ?></h3>
                       </div>
   ...
   <div class="d-flex  flex-sm-row flex-column  justify-content-between">
    ...
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
     <p>
        <?= Html::a('<i class="fas fa-plus"></i> Add Event Category', ['create'], ['class' => 'btn btn-outline-primary btn-lg action-createx','title'=>'Add New Event Category']) ?>
    </p>   
